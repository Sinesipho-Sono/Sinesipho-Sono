# Hello, I'm Sinesipho Sono! 🦋
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=700&size=25&pause=1000&color=0C2B39&width=435&lines=Software+Developer%2FEngineer;Frontend+Engineer;Fullstack+Developer%2FEngineer)](https://git.io/typing-svg)
...
- **API Integration:** REST APIs, Axios for data fetching
...
### Current Focus:
-  Learning Backend Languages (C#, C++) to become a Full stack developer
-  Building more complex applications with backend functionality
-  Exploring REST APIs and integrations to create innovative solutions
...
*"Passionate about creating digital web experiences that make a difference!"* 
